...
<?php endif; ?><?php 
 if ($result->num_rows > 0) {
    echo '<form action="../controller/procesar_incentivosp2.php" method="POST">';
    echo '<table>';
    echo '<tr>';
    echo '<th>Nombre</th>';
    echo '<th>Lunes</th>';
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td><input type="number" name="eficiencia_lunes[' . $row['id_precilla2'] . ']" value="' . htmlspecialchars($row['eficiencia_lunes'] ?? '') . '"></td>';
        echo '<td><input type="number" name="eficiencia_martes[' . $row['id_precilla2'] . ']" value="' . htmlspecialchars($row['eficiencia_martes'] ?? '') . '"></td>';
        echo '<td><input type="number" name="eficiencia_miercoles[' . $row['id_precilla2'] . ']" value="' . htmlspecialchars($row['eficiencia_miercoles'] ?? '') . '"></td>';
        echo '<td><input type="number" name="eficiencia_jueves[' . $row['id_precilla2'] . ']" value="' . htmlspecialchars($row['eficiencia_jueves'] ?? '') . '"></td>';
        echo '<td><input type="number" name="eficiencia_viernes[' . $row['id_precilla2'] . ']" value="' . htmlspecialchars($row['eficiencia_viernes'] ?? '') . '"></td>';
        echo '<td><input type="number" name="eficiencia_sabado[' . $row['id_precilla2'] . ']" value="' . htmlspecialchars($row['eficiencia_sabado'] ?? '') . '"></td>';
