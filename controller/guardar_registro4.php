...
foreach ($lunes as $modulo => $dias) {
    ...
    $consulta_eliminar = "DELETE FROM incentivo4 WHERE modulo = '$modulo'";
    ...
    // Insertar los nuevos resultados en la tabla incentivo4
    $fecha_actual = date("Y-m-d");
    $sql_insert = "INSERT INTO incentivo4 (eficiencia, modulo, fecha, valor, valor_lunes, valor_martes, valor_miercoles, valor_jueves, valor_viernes, valor_sabado, 
