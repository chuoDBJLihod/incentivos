...
foreach ($lunes as $modulo => $dias) {
    ...
    $consulta_eliminar = "DELETE FROM incentivo1 WHERE modulo = '$modulo'";
    ...
    // Insertar los nuevos resultados en la tabla incentivo1
    $fecha_actual = date("Y-m-d");
    $sql_insert = "INSERT INTO incentivo1 (eficiencia, modulo, fecha, valor, valor_lunes, valor_martes, valor_miercoles, valor_jueves, valor_viernes, valor_sabado, 
