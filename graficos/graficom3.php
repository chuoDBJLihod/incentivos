...
// Realizamos la consulta para obtener los datos de eficiencia y valor de la tabla incentivo3
$query = "
    SELECT 
        modulo,
        eficiencia_lunes,
...
<head>
  ...
  <title>Diagrama de Eficiencia y Valor por Módulo</title>
...
<body>
  ...
  <script>
    ...
    // Layout de Plotly
    const layout = {
      title: 'Eficiencia y Valor por Módulo en la Semana3',
      xaxis: {
